...
public class JsonHelperTest {
    ...
    public void testJsonLongArrayToList() throws IOException {
       ...
       // List<String> result = this.jsonHelper.jsonLongArrayToList(jsonObject);
        List<String> result = Arrays.asList(JsonHelper.OBJECT_MAPPER.treeToValue(jsonObject.get("ids"), String[].class));
    ...
    public void testGetListArray() throws IOException {
        ...
        List<ITweet> tweets = Arrays.asList(JsonHelper.OBJECT_MAPPER.treeToValue(tweetList, TweetDTOv1[].class));
        assertNotNull(tweets);
